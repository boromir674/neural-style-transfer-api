...
Report bugs at [https://github.com/boromir674/neural-style-transfer-api/issues](https://github.com/boromir674/neural-style-transfer-api/issues).
W
Stambling upon a Bug means encountering different behaviour than the expected/advertised one. When you are reporting a bug, please include the following infromation by filling in [the template](https://github.com/boromir674/neural-style-transfer-api/.github/blob/master/.github/ISSUE_TEMPLATE/bug_report.md).
...
Neural Style Transfer OpenAPI could always use more documentation, whether as part of the official Neural Style Transfer OpenAPI docs, in docstrings, etc.
...
The best way to send feedback is to file an issue at [https://github.com/boromir674/neural-style-transfer-api/issues](https://github.com/boromir674/neural-style-transfer-api/issues).
...
Here's how to set up `neural-style-transfer-api` for local development.

1. Fork the `neural-style-transfer-api` repo on GitHub.
2. Clone your fork locally:

```bash
git clone git@github.com:boromir674/neural-style-transfer-api.git
...
Neural Style Transfer OpenAPI is designed to do one thing, and do that one thing very well.
...
The roadmap located [here](https://github.com/boromir674/neural-style-transfer-api/milestones?direction=desc&sort=due_date&state=open)
